...
First, let's take a look at the distribution of repeat allegations. In order to be included in the dataset, officers must have at least one substantiated allegation against them. In the below histogram, we can see that, indeed, for officers with only one allegation, it was substantiated.  This data inclusion condition skews the proportion of officers with fewer allegations toward substantiated.

We can also see that 50% of officers in this dataset have about 13 or fewer allegations. Also, some officers, have as many as 70 allegations against them.
...
The number of repeat allegations against officers varies by the race of the complainant.  The below plot groups repeat allegations by the identified race of the complainant (meaning that an officer with 1 substantiated allegation from a white complainant and 1 unsubstantiated allegations from a P.O.C. complainant would represent an officer with 1 allegation in each facet).  This grouping demonstrates that the majority of complaints
...
```{r echo=F}
knitr::include_graphics("../src/visualizations/Visuals_files/figure-html/repeat_complaints_eth-3.png")
```
